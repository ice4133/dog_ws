...
bool unitree_legged_msgs__msg__motor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_legged_msgs.msg._motor_state.MotorState", full_classname_dest, 47) == 0);
  }
  unitree_legged_msgs__msg__MotorState * ros_message = _ros_message;
  {  // mode
  ...
  {  // tau_est
    ...
    ros_message->tau_est = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // q
...
PyObject * unitree_legged_msgs__msg__motor_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_legged_msgs.msg._motor_state");
