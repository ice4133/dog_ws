...
gait_angles = [
    ...
    GaitAngle(0, 20.0, 0, 20.0,0, 20.0, 0, 20.0),#shangpo
...
state_detached_params = [
    #STOP 0
    DetachedParam(
        GaitParams(21.8, 0.0, 0, 0.00, 0.5, 0.0),
        GaitParams(21.8, 0.0, 0, 0.00, 0.5, 0.0),
        GaitParams(21.8, 0.0, 0, 0.00, 0.5, 0.0),
        GaitParams(21.8, 0.0, 0, 0.00, 0.5, 0.0),
    ...
    # TROT 1
    DetachedParam(   
        GaitParams(21.8, 12, 3, 1.0, 0.25, 17.0),#21.8,15,4,0.5,0.35,2.0
        GaitParams(21.8, 12, 3, 1.0, 0.25, 17.0),
        GaitParams(21.8, 12, 3, 1.0, 0.25, 17.0),
        GaitParams(21.8, 12, 3, 1.0, 0.25, 17.0), 
    ...
    # TROT_BACK 2
    DetachedParam(
        GaitParams(21.8, 12.0, 4.0, 0.00, 0.35, 14.0),
        GaitParams(21.8, 12.0, 4.0, 0.00, 0.35, 14.0),
        GaitParams(21.8, 12.0, 4.0, 0.00, 0.35, 14.0),
        GaitParams(21.8, 12.0, 4.0, 0.00, 0.35, 14.0),
    ),
    #TROT_BACK_RIGHT 3    
    DetachedParam(
        GaitParams(21.8, 18.0, 4.50, 0.00, 0.35, 20.0),
        GaitParams(21.8, 10.0, 4.50, 0.00, 0.35, 20.0),
        GaitParams(21.8, 18.0, 4.50, 0.00, 0.35, 20.0),
        GaitParams(21.8, 10.0, 4.50, 0.00, 0.35, 20.0),
    ),   
    #TROT_BACK_LEFT 4  
    ...
    #TROT_LEFT = 5 
    DetachedParam(
        GaitParams(21.8, 5.0, 4.50, 0.00, 0.35, 12.0),
        GaitParams(21.8, 18.0, 4.50, 0.00, 0.35,12.0),
        GaitParams(21.8, 5.0, 4.50, 0.00, 0.35, 12.0),
        GaitParams(21.8, 18.0, 4.50, 0.00, 0.35, 12.0),
    ),        
    #TROT_RIGHT = 6  
    ...
    #ROTATE_LEFT = 7
    DetachedParam(
        GaitParams(21.8, 7.0, 3.50, 0.00, 0.25, 17.0),
        GaitParams(21.8, 7.0, 3.50, 0.00, 0.25, 17.0),
        GaitParams(21.8, 7.0, 3.50, 0.00, 0.25, 17.0),
        GaitParams(21.8, 7.0, 3.50, 0.00, 0.25, 17.0),
    ),
    ...
    DetachedParam(
        ...
        # GaitParams(21.8, 7.0, 8.0, 0.00, 0.35, 12),
        GaitParams(21.8, 12, 5.0, 0.00, 0.35, 28),
        GaitParams(21.8, 12, 5.0, 0.00, 0.35, 28),
        GaitParams(21.8, 12, 3.0, 0.00, 0.35, 28),
        GaitParams(21.8, 12, 3.0, 0.00, 0.35, 28),
    ),
    #slow_TORT = 10
    DetachedParam(   
...
def cartesian_to_theta(leg_id, leg_direction):
    ...
    cos_param_M[leg_id] = (L1**2 + L[leg_id]**2 - L2**2  ) / (2.0 * L1 * L)
    ...
    A1[leg_id] = 90 +M[leg_id] - N[leg_id]#大腿（左）右反
    A2[leg_id] = T[leg_id]-28.5#小腿(右)
    
    # A1[leg_id] = M[leg_id] - N[leg_id]
    # A2[leg_id] = M[leg_id] + N[leg_id]

    if leg_direction == 1.0:
        theta1[leg_id] = A2[leg_id]  #小腿右
        theta2[leg_id] = A1[leg_id]  #大腿左
    elif leg_direction == -1.0:
        theta1[leg_id] = -A2[leg_id]
        theta2[leg_id] = -A1[leg_id]
...
def set_all_legs_coupled_position(leg_id, leg1_angle_0, leg1_angle_1,leg2_angle_2, leg2_angle_3,leg3_angle_4, leg3_angle_5,leg4_angle_6,leg4_angle_7):
    ...
    #计算每个电机的最终旋转圈数(弧度)
    pos[0] = deg_2_cir(temp_pid.ref_agle[0])  #- deg_2_cir(leg1_angle_0)#-0.25
    pos[1] = deg_2_cir(temp_pid.ref_agle[1]) #- deg_2_cir(leg1_angle_1)#-0.25
    pos[2] = deg_2_cir(temp_pid.ref_agle[2])  #+ deg_2_cir(leg2_angle_2)#+0.25
    pos[3] = deg_2_cir(temp_pid.ref_agle[3])  #+ deg_2_cir(leg2_angle_3)#+0.25
    pos[4] = deg_2_cir(temp_pid.ref_agle[4])  #+ deg_2_cir(leg3_angle_4)#+0.25
    pos[5] = deg_2_cir(temp_pid.ref_agle[5])  #+ deg_2_cir(leg3_angle_5)#+0.25
    pos[6] = deg_2_cir(temp_pid.ref_agle[6])  #- deg_2_cir(leg4_angle_6)#-0.25
    pos[7] = deg_2_cir(temp_pid.ref_agle[7])  #- deg_2_cir(leg4_angle_7)#-0.25
