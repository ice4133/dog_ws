...
: ${AMENT_CURRENT_PREFIX:="/home/i-mini900/dog/dog_ws/install/robot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot/environment/pythonpath.sh"
